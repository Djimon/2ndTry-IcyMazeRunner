...
namespace IcyMazeRunner
{
    class Player
    {
        ...
        public void move(Map map, GameTime time)
        {
            ...
            if (Keyboard.IsKeyPressed(Keyboard.Key.A) && map.iswalkable((int)(playerSprite.Position.X), (int)(playerSprite.Position.Y))) 
            {
            ...
            if (Keyboard.IsKeyPressed(Keyboard.Key.D) && map.iswalkable((int)(playerSprite.Position.X), (int)(playerSprite.Position.Y))) 
            {
                playerPosition = new Vector2f(playerPosition.X + runningSpeed, playerPosition.Y);
            ...
            if (Keyboard.IsKeyPressed(Keyboard.Key.W) && map.iswalkable((int)(playerSprite.Position.X), (int)(playerSprite.Position.Y))) 
            {
            ...
            if (Keyboard.IsKeyPressed(Keyboard.Key.S) && map.iswalkable((int)(playerSprite.Position.X), (int)(playerSprite.Position.Y))) 
            {
                playerPosition = new Vector2f(playerPosition.X, playerPosition.Y + runningSpeed);
